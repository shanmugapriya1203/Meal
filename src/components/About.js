...
const About = () => {
  return (
    <div className="p-4 md:p-8 rounded-lg shadow-lg">
      <h1 className="text-xl md:text-3xl font-semibold mb-4">About Us</h1>
      ...
      <div className="mt-4 md:mt-6">
        ...
        <p className="text-sm md:text-base">Phone: <span className="text-green-500">+91 9856778952</span></p>
      </div>
    </div>
  );
};
